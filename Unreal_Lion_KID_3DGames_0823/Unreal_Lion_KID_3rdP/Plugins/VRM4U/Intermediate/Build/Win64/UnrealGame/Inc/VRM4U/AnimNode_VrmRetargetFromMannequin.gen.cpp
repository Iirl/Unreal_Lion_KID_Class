...
template<> VRM4U_API UScriptStruct* StaticStruct<FAnimNode_VrmRetargetFromMannequin>()
{
	...
	struct Z_CompiledInDeferFile_FID_Unreal_Lion_KID_3rdP_Plugins_VRM4U_Source_VRM4U_Public_AnimNode_VrmRetargetFromMannequin_h_Statics
	{
		static const FStructRegisterCompiledInInfo ScriptStructInfo[];
	};
	const FStructRegisterCompiledInInfo Z_CompiledInDeferFile_FID_Unreal_Lion_KID_3rdP_Plugins_VRM4U_Source_VRM4U_Public_AnimNode_VrmRetargetFromMannequin_h_Statics::ScriptStructInfo[] = {
		{ FAnimNode_VrmRetargetFromMannequin::StaticStruct, Z_Construct_UScriptStruct_FAnimNode_VrmRetargetFromMannequin_Statics::NewStructOps, TEXT("AnimNode_VrmRetargetFromMannequin"), &Z_Registration_Info_UScriptStruct_AnimNode_VrmRetargetFromMannequin, CONSTRUCT_RELOAD_VERSION_INFO(FStructReloadVersionInfo, sizeof(FAnimNode_VrmRetargetFromMannequin), 1964355276U) },
	};
	static FRegisterCompiledInInfo Z_CompiledInDeferFile_FID_Unreal_Lion_KID_3rdP_Plugins_VRM4U_Source_VRM4U_Public_AnimNode_VrmRetargetFromMannequin_h_2267041934(TEXT("/Script/VRM4U"),
		nullptr, 0,
		Z_CompiledInDeferFile_FID_Unreal_Lion_KID_3rdP_Plugins_VRM4U_Source_VRM4U_Public_AnimNode_VrmRetargetFromMannequin_h_Statics::ScriptStructInfo, UE_ARRAY_COUNT(Z_CompiledInDeferFile_FID_Unreal_Lion_KID_3rdP_Plugins_VRM4U_Source_VRM4U_Public_AnimNode_VrmRetargetFromMannequin_h_Statics::ScriptStructInfo),
		nullptr, 0);
