...
// End Cross Module References
...
#if WITH_METADATA
		static const UECodeGen_Private::FMetaDataPairParam NewProp_bVrm10Normalize_MetaData[];
#endif
		static void NewProp_bVrm10Normalize_SetBit(void* Obj);
		static const UECodeGen_Private::FBoolPropertyParams NewProp_bVrm10Normalize;
#if WITH_METADATA
...
#if WITH_METADATA
	const UECodeGen_Private::FMetaDataPairParam Z_Construct_UClass_UVrmImportUI_Statics::NewProp_bVrm10Normalize_MetaData[] = {
		{ "Category", "Mesh" },
		{ "Comment", "/** Normalize axis for VRM10 */" },
		{ "DisplayName", "NormalizeForVRM10" },
		{ "ImportType", "StaticMesh|SkeletalMesh" },
		{ "ModuleRelativePath", "Private/VrmImportUI.h" },
		{ "ToolTip", "Normalize axis for VRM10" },
	};
#endif
	void Z_Construct_UClass_UVrmImportUI_Statics::NewProp_bVrm10Normalize_SetBit(void* Obj)
	{
		((UVrmImportUI*)Obj)->bVrm10Normalize = 1;
	}
	const UECodeGen_Private::FBoolPropertyParams Z_Construct_UClass_UVrmImportUI_Statics::NewProp_bVrm10Normalize = { "bVrm10Normalize", nullptr, (EPropertyFlags)0x0010040000000005, UECodeGen_Private::EPropertyGenFlags::Bool | UECodeGen_Private::EPropertyGenFlags::NativeBool, RF_Public|RF_Transient|RF_MarkAsNative, 1, sizeof(bool), sizeof(UVrmImportUI), &Z_Construct_UClass_UVrmImportUI_Statics::NewProp_bVrm10Normalize_SetBit, METADATA_PARAMS(Z_Construct_UClass_UVrmImportUI_Statics::NewProp_bVrm10Normalize_MetaData, UE_ARRAY_COUNT(Z_Construct_UClass_UVrmImportUI_Statics::NewProp_bVrm10Normalize_MetaData)) };
#if WITH_METADATA
	...
	const UECodeGen_Private::FPropertyParamsBase* const Z_Construct_UClass_UVrmImportUI_Statics::PropPointers[] = {
		...
		(const UECodeGen_Private::FPropertyParamsBase*)&Z_Construct_UClass_UVrmImportUI_Statics::NewProp_bVrm10Normalize,
	...
	struct Z_CompiledInDeferFile_FID_Unreal_Lion_KID_3rdP_Plugins_VRM4U_Source_VRM4UImporter_Private_VrmImportUI_h_Statics
	{
		static const FClassRegisterCompiledInInfo ClassInfo[];
	};
	const FClassRegisterCompiledInInfo Z_CompiledInDeferFile_FID_Unreal_Lion_KID_3rdP_Plugins_VRM4U_Source_VRM4UImporter_Private_VrmImportUI_h_Statics::ClassInfo[] = {
		{ Z_Construct_UClass_UVrmImportUI, UVrmImportUI::StaticClass, TEXT("UVrmImportUI"), &Z_Registration_Info_UClass_UVrmImportUI, CONSTRUCT_RELOAD_VERSION_INFO(FClassReloadVersionInfo, sizeof(UVrmImportUI), 873225578U) },
	};
	static FRegisterCompiledInInfo Z_CompiledInDeferFile_FID_Unreal_Lion_KID_3rdP_Plugins_VRM4U_Source_VRM4UImporter_Private_VrmImportUI_h_3506167728(TEXT("/Script/VRM4UImporter"),
		Z_CompiledInDeferFile_FID_Unreal_Lion_KID_3rdP_Plugins_VRM4U_Source_VRM4UImporter_Private_VrmImportUI_h_Statics::ClassInfo, UE_ARRAY_COUNT(Z_CompiledInDeferFile_FID_Unreal_Lion_KID_3rdP_Plugins_VRM4U_Source_VRM4UImporter_Private_VrmImportUI_h_Statics::ClassInfo),
		nullptr, 0,
		nullptr, 0);
